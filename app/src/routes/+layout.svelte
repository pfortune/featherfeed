...
<nav class="bg-white shadow">
			...
			<div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
             ...
             {$activeRoute === '/'
					...
					<a
						href="/detections"
						class="inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium
             {$activeRoute.startsWith('/detection')
							? 'border-indigo-500 text-gray-900'
							: 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}"
					>
						Detections
					...
					<a
						href="https://github.com/pfortune/FeatherFeed"
						target="_blank"
	...
	<div class={isMobileMenuOpen ? '' : 'hidden'} id="mobile-menu">
		<div class="space-y-1 pb-4 pt-2">
			<a
				href="/"
				class="block border-l-4 py-2 pl-3 pr-4 text-base font-medium {$activeRoute === '/'
			...
			<a
				href="/detections"
				class="block border-l-4 py-2 pl-3 pr-4 text-base font-medium {$activeRoute.startsWith(
					'/detection'
				)
					? 'border-indigo-500 bg-indigo-50 text-indigo-700'
					: 'border-transparent text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700'}"
